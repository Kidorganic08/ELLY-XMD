...
✔Now click on this devs number and give 𝙴𝙻𝙻𝚈-𝚇𝙼𝙳 owner credits https://wa.me/+255772341432
╰────────────────────☆`;
let menuMsg = `
     𝐑𝐞𝐠𝐚𝐫𝐝𝐬 𝙴𝙻𝙻𝚈-𝚇𝙼𝙳`;
   var lien = mybotpic();
   ...
   if (lien.match(/\.(mp4|gif)$/i)) {
    try {
        zk.sendMessage(dest, { video: { url: lien }, caption:infoMsg + menuMsg, footer: "Je suis *hans*, déveloper 𝙴𝙻𝙻𝚈-𝚇𝙼𝙳" , gifPlayback : true }, { quoted: ms });
    }
    catch (e) {
