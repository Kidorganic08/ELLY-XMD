...
adams({
  nomCom: "audio",  // Changed to a unique command name
  ...
  try {
    ...
    const fastResponse = {
      text: `*ELLY XMD is downloading ${firstVideo.title}*`,
      contextInfo: {
        externalAdReply: {
          title: firstVideo.title,
          body: "elly xmd downloader",
          mediaType: 1,
          thumbnailUrl: "https://files.catbox.moe/f15ml0.jpg",
