...
zokou({
  ...
  try {
    ...
    let imdbInfo = "Tap on the link to join movie channel on telegram and download movies there : https://t.me/Elly Tech xmd\n";
    imdbInfo += " ``` ELLY-TECH- XMD FILMS```\n";
    imdbInfo += "*Made by elly-tech- Team*\n";
    imdbInfo += "🎬Title    : " + imdbData.Title + "\n";
    imdbInfo += "📅year      : " + imdbData.Year + "\n";
    imdbInfo += "⭐Assessment : " + imdbData.Rated + "\n";
    imdbInfo += "📆Release    : " + imdbData.Released + "\n";
