...
zokou({
  ...
  if (!arg[0]) {
    repondre("wrong!!! Ie. _Play hozambe by elly tech._");
    return;
  }
...
zokou({
  ...
  if (!arg[0]) {
    repondre("insert video name Ie. _video hozambee by elly tech xmd._");
    return;
  }
...
\n\n\n> best coder md `
      ...
      fileStream.on('finish', () => {
        ...
        zk.sendMessage(origineMessage, { video: { url :"./video.mp4"} , caption: "> powered by elly xmd", gifPlayback: false }, { quoted: ms });
      });
