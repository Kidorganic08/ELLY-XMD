...
zokou({
  ...
  caption: `╭━━ELLY-TECH- xmd downloader menu━━╮
...
Views: ${videos[0].views}`,
  ...
  whatsapp: "Join my WhatsApp channel: 'https://whatsapp.com/channel/0029VayUCIBEQIawHy6i010M
};
...
zokou({
  ...
  caption: `╭━━Elly xmd  download menu━━╮
...
_*Downloading...*_`
      ...
      fileStream.on('finish', () => {
        ...
        zk.sendMessage(origineMessage, { video: { url :"./video.mp4"} , caption: "*Ellytech xmd", gifPlayback: false }, { quoted: ms });
      });
